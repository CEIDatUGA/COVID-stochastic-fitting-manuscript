...
/* Time: 2022-07-27 18:13:59.649 -0600 */
/* Salt: 898BCAEE5FC60A6BD171D7A8 */
...
#define S_0		(__p[__parindex[43]])
#define E1_0		(__p[__parindex[44]])
#define Ia1_0		(__p[__parindex[45]])
#define Isu1_0		(__p[__parindex[46]])
#define Isd1_0		(__p[__parindex[47]])
#define C1_0		(__p[__parindex[48]])
#define H1_0		(__p[__parindex[49]])
#define R_0		(__p[__parindex[50]])
#define D_0		(__p[__parindex[51]])
#define trendO_0		(__p[__parindex[52]])
